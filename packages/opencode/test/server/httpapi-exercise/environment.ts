...
export const exerciseConfigDirectory = path.join(exerciseGlobalRoot, "config", "amio")
export const exerciseDataDirectory = path.join(exerciseGlobalRoot, "data", "amio")
